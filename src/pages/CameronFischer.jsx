...
function CameronFischer(){
    return (
        <div style={{textAlign:"center", color: 'black', backgroundColor: 'gold'}}>
            <img style={{width: 231.5, height: 400, border: '1px solid black'}} src={CameronPicture}/>
            <h1>Cameron Fischer</h1>
            <p></p>
            <h2>About Me:</h2>
            <h3>I'm from Davenport, Iowa. Currently majoring in Computer Science and Engineering</h3>
            <h3> with a focus in Software Engineering. I plan to work in the .NET environment</h3> 
            <h3>with a focus on backend development. In my freetime I like to play soccer, </h3>
            <h3> video games, and go to the gym. 
            </h3>
            <h2>Contact Me:</h2>
